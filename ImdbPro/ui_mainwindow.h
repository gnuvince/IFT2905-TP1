...
public:
    ...
    QLabel *label_23;
    QListWidget *film_music_department;
    QVBoxLayout *verticalLayout_22;
    QLabel *label_22;
    QListWidget *film_sound_crew;
    QVBoxLayout *verticalLayout_23;
    QLabel *label_24;
    QListWidget *film_set_decoration;
    QVBoxLayout *verticalLayout_28;
    QVBoxLayout *verticalLayout_25;
    QLabel *label_20;
    QListWidget *film_art_department;
    QVBoxLayout *verticalLayout_26;
    QLabel *label_21;
    QListWidget *film_camera_and_electrical_department;
    QVBoxLayout *verticalLayout_27;
    QLabel *label_17;
    QListWidget *film_costume_department;
    QWidget *tab;
    QHBoxLayout *horizontalLayout_12;
    QVBoxLayout *verticalLayout_33;
    QVBoxLayout *verticalLayout_29;
    QLabel *label_18;
    QListWidget *film_sfx_department;
    QVBoxLayout *verticalLayout_32;
    QLabel *label_19;
    QListWidget *film_sfx_companies;
    QVBoxLayout *verticalLayout_34;
    QVBoxLayout *verticalLayout_30;
    QLabel *label_16;
    QListWidget *film_visual_effects;
    QVBoxLayout *verticalLayout_31;
    QLabel *label;
    QListWidget *film_animation_department;
    QWidget *tab_misc;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalLayout_3->addWidget(film_casting_director_lbl);
        ...
        horizontalLayout_3->addWidget(film_casting_director);
        ...
        verticalLayout_12->addWidget(film_stunt_performer_lbl);
        ...
        verticalLayout_12->addWidget(film_stunt_performers);
        ...
        verticalLayout_9->addWidget(film_producer_lbl);

        film_producer = new QListWidget(tab_production);
        film_producer->setObjectName(QString::fromUtf8("film_producer"));

        verticalLayout_9->addWidget(film_producer);


        verticalLayout_18->addLayout(verticalLayout_9);
        ...
        verticalLayout_14->addWidget(film_production_companies_lbl);
        ...
        verticalLayout_14->addWidget(film_production_companies);
        ...
        label_23 = new QLabel(tab_technical);
        label_23->setObjectName(QString::fromUtf8("label_23"));

        verticalLayout_21->addWidget(label_23);

        film_music_department = new QListWidget(tab_technical);
        film_music_department->setObjectName(QString::fromUtf8("film_music_department"));

        verticalLayout_21->addWidget(film_music_department);
        ...
        label_22 = new QLabel(tab_technical);
        label_22->setObjectName(QString::fromUtf8("label_22"));

        verticalLayout_22->addWidget(label_22);

        film_sound_crew = new QListWidget(tab_technical);
        film_sound_crew->setObjectName(QString::fromUtf8("film_sound_crew"));

        verticalLayout_22->addWidget(film_sound_crew);
        ...
        label_24 = new QLabel(tab_technical);
        label_24->setObjectName(QString::fromUtf8("label_24"));

        verticalLayout_23->addWidget(label_24);

        film_set_decoration = new QListWidget(tab_technical);
        film_set_decoration->setObjectName(QString::fromUtf8("film_set_decoration"));

        verticalLayout_23->addWidget(film_set_decoration);
        ...
        label_20 = new QLabel(tab_technical);
        label_20->setObjectName(QString::fromUtf8("label_20"));

        verticalLayout_25->addWidget(label_20);

        film_art_department = new QListWidget(tab_technical);
        film_art_department->setObjectName(QString::fromUtf8("film_art_department"));

        verticalLayout_25->addWidget(film_art_department);
        ...
        label_21 = new QLabel(tab_technical);
        label_21->setObjectName(QString::fromUtf8("label_21"));

        verticalLayout_26->addWidget(label_21);

        film_camera_and_electrical_department = new QListWidget(tab_technical);
        film_camera_and_electrical_department->setObjectName(QString::fromUtf8("film_camera_and_electrical_department"));

        verticalLayout_26->addWidget(film_camera_and_electrical_department);
        ...
        label_17 = new QLabel(tab_technical);
        label_17->setObjectName(QString::fromUtf8("label_17"));

        verticalLayout_27->addWidget(label_17);

        film_costume_department = new QListWidget(tab_technical);
        film_costume_department->setObjectName(QString::fromUtf8("film_costume_department"));

        verticalLayout_27->addWidget(film_costume_department);
        ...
        verticalLayout_29->addWidget(label_18);

        film_sfx_department = new QListWidget(tab);
        film_sfx_department->setObjectName(QString::fromUtf8("film_sfx_department"));

        verticalLayout_29->addWidget(film_sfx_department);


        verticalLayout_33->addLayout(verticalLayout_29);
        ...
        verticalLayout_32->addWidget(label_19);

        film_sfx_companies = new QListWidget(tab);
        film_sfx_companies->setObjectName(QString::fromUtf8("film_sfx_companies"));

        verticalLayout_32->addWidget(film_sfx_companies);


        verticalLayout_33->addLayout(verticalLayout_32);


        horizontalLayout_12->addLayout(verticalLayout_33);
        ...
        film_visual_effects = new QListWidget(tab);
        film_visual_effects->setObjectName(QString::fromUtf8("film_visual_effects"));

        verticalLayout_30->addWidget(film_visual_effects);
        ...
        verticalLayout_31->addWidget(label);

        film_animation_department = new QListWidget(tab);
        film_animation_department->setObjectName(QString::fromUtf8("film_animation_department"));

        verticalLayout_31->addWidget(film_animation_department);
        ...
        scrollArea = new QScrollArea(tab_fullcover);
        ...
        film_fullsize_cover = new QLabel(scrollAreaWidgetContents);
        film_fullsize_cover->setObjectName(QString::fromUtf8("film_fullsize_cover"));
        film_fullsize_cover->setMaximumSize(QSize(16777215, 16777215));
        film_fullsize_cover->setScaledContents(false);
        film_fullsize_cover->setAlignment(Qt::AlignCenter);

        verticalLayout_10->addWidget(film_fullsize_cover);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        film_aspect_ratio->setText(QString());
        ...
        film_mpaa_rating->setText(QString());
        ...
        film_cinematographer->setText(QString());
